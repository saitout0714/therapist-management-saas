...
async function run() {
    ...
    await page.goto('https://www.esthe-ranking.jp/shop/image/girl/upload/', { waitUntil: 'domcontentloaded' });
    ...
    console.log('Inputs on /upload/:', JSON.stringify(elements.filter(i => i.type !== 'hidden').slice(0, 15), null, 2));
