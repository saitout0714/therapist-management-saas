...
export const SITES: SiteConfig[] = [
  ...
  {
    name: 'バカラ周南下松',
    shopId: 'e6b1cc21-c9eb-4fc1-888d-6f965a90c1df',
    type: 'tsujido',
  ...
  {
    name: 'バカラ山口湯田',
    shopId: '508def9b-cd72-439d-9bbc-2dbe5e3a8af4',
    type: 'tsujido',
  ...
  {
    name: 'バカラ宇部',
    shopId: '11013a02-86fe-4675-83e2-9e11f459d416',
    type: 'tsujido',
  ...
  {
    name: 'バカラ岩国',
    shopId: 'b99522d0-5166-4f7d-87d5-801699f5ba3c',
    type: 'tsujido',
