...
// accent: ドット・区切り線 / band: 見出し帯の地色 / cell: 出勤セル・行の地色 / text: 見出し文字
...
export const ROOM_TONES: GroupTone[] = [
  { accent: '#64748B', band: 'rgba(100,116,139,0.06)', cell: 'transparent', text: '#334155' },
];

export const FREE_TONE: GroupTone = { accent: '#94A3B8', band: 'rgba(100,116,139,0.06)', cell: 'transparent', text: '#475569' };
export const OFF_TONE: GroupTone = { accent: '#FB7185', band: 'rgba(244,63,94,0.14)', cell: 'transparent', text: '#9F1239' };
