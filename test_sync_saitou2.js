...
async function run() {
    ...
    // Inspect save button JS
    const saveBtnHtml = await page.evaluate(() => {
        const btn = document.querySelector('a.btn-default_submit');
        return btn ? btn.outerHTML : 'NOT FOUND';
    });
    console.log('Save Button Outer HTML:', saveBtnHtml);
    ...
    console.log('URL after eval click:', page.url());
