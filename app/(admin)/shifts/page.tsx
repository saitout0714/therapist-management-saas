        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-2 md:p-4 mb-2 md:mb-3">
          <div className="flex flex-col md:flex-row md:flex-wrap md:items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-md shadow-sm transition-colors font-bold text-xs whitespace-nowrap flex items-center gap-1.5 md:ml-auto"
            >
