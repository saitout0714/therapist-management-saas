        ...
        <div className="mb-6 flex-shrink-0 flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          {['developer', 'system_admin'].includes(user?.role || '') && (
            <button
              ...
              className="px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-md shadow-sm transition-colors font-bold text-xs whitespace-nowrap flex items-center gap-1.5 self-start md:self-auto"
            >
              ...
              {aiModal.parsedShifts === null ? (
                ...
                <>
                  <button
                    ...
                    className="btn-primary flex-1 px-0 flex items-center justify-center gap-2"
                  >
                    {aiModal.saving ? (
                      <>
                        <svg className="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" /><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" /></svg>
