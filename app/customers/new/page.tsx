...
export default function NewCustomerPage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('顧客の登録に失敗', err)
      setError('顧客の登録に失敗しました: ' + message)
      setLoading(false)
    }
  }
    ...
    <div className="min-h-screen bg-gray-100 p-6 md:p-8">
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-800 tracking-tight">顧客の新規登録</h1>
            <p className="text-sm text-slate-500 mt-1">新しいお客様情報を登録します。</p>
          </div>
        </div>
