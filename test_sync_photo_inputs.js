...
async function run() {
    ...
    console.log('--- ESTAMA PHOTO INPUTS ---');
    ...
    const estamaFiles = await page.evaluate(() => {
    ...
    console.log('Estama File Inputs:', estamaFiles);

    console.log('--- ESTHE RANKING PHOTO INPUTS ---');
    ...
    console.log('ER File Inputs:', erFiles);
