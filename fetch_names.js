...
async function test() {
  ...
  await page1.click('button.login_btn');
  await page1.waitForNavigation({ waitUntil: 'domcontentloaded' }).catch(() => {});
  ...
  await page2.waitForNavigation({ waitUntil: 'domcontentloaded' }).catch(() => {});
